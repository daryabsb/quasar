  ...
  <q-layout view="hHh lpR fFf">
    <q-header elevated class="q-py-md">
      <q-toolbar>
        ...
        <q-space></q-space>
        <q-btn-toggle v-model="model" flat stretch toggle-color="yellow" :options="options" size="lg"></q-btn-toggle>
        <q-space></q-space>
    ...
    <q-footer bordered class="bg-grey-8 text-white q-py-md q-px-lg">
      <q-toolbar>
        <q-toolbar-title>
          <q-avatar>
